...
const Column = ({ title, tickets, ordering, grouping }) => {
  return (
    <div className={styles.column} style={{backgroundColor:"transparent"}}>
      <div className={styles.leftview} style={{backgroundColor:"transparent"}}>
        <div className="dot">
          {grouping !== undefined && grouping === "user" ? (
            <>
              <div>
                <AvatarWithStatus statusColor={"green"} grouping={grouping} indashBoard={grouping === "user"} style={{backgroundColor:"transparent"}}/>
              </div>
            </>
          ) : (
            <>{icons[title]}</>
        ...
        <div className={styles.name_label} style={{backgroundColor:"transparent"}}>
        <h5 style={{backgroundColor:"transparent"}}> {title}</h5>
        <h5 className="heading" style={{backgroundColor:"transparent"}}>{tickets.length}</h5>
        </div>
